...
public abstract class QRecyclerAdapter<T> extends RecyclerView.Adapter<QRecyclerViewHolder> {
    ...
    protected static final String TAG = QRecyclerAdapter.class.getSimpleName();
     ...
     */
    protected QRecyclerAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    protected QRecyclerAdapter(@Nullable List<T> data) {
        this(0, data);
    }

    public QRecyclerAdapter(@LayoutRes int layoutResId) {
    ...
    @NonNull
    @Override
    public QRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        QRecyclerViewHolder baseViewHolder = null;
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull QRecyclerViewHolder holder) {
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull QRecyclerViewHolder holder, int position) {
    ...
    @Override
    public void onBindViewHolder(@NonNull QRecyclerViewHolder holder, int position, @NonNull List<Object> payloads) {
        if (payloads.isEmpty()) {
    ...
    private void bindViewClickListener(final QRecyclerViewHolder QRecyclerViewHolder) {
        if (QRecyclerViewHolder == null) {
            return;
        }
        final View view = QRecyclerViewHolder.itemView;
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    int position = QRecyclerViewHolder.getAdapterPosition();
    ...
    public void setOnItemClick(View v, int position) {
        getOnItemClickListener().onItemClick(QRecyclerAdapter.this, v, position);
    }
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(QRecyclerAdapter.this, v, position);
    }


    protected QRecyclerViewHolder onCreateDefViewHolder(ViewGroup parent, int viewType) {
        int layoutId = mLayoutResId;
        return createBaseViewHolder(parent, layoutId);
    }

    protected QRecyclerViewHolder createBaseViewHolder(ViewGroup parent, int layoutResId) {
        return createBaseViewHolder(getItemView(layoutResId, parent));
    }

    protected QRecyclerViewHolder createBaseViewHolder(View view) {
     ...
     */
    protected abstract void convert(@NonNull QRecyclerViewHolder helper, T item);


    protected void convertPayloads(@NonNull QRecyclerViewHolder helper, T item, @NonNull List<Object> payloads) {
    }
    ...
    public View getViewByPosition(RecyclerView recyclerView, int position, @IdRes int viewId) {
        ...
        QRecyclerViewHolder viewHolder = (QRecyclerViewHolder) recyclerView.findViewHolderForLayoutPosition(position);
        if (viewHolder == null) {
            return null;
        }
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(QRecyclerAdapter<?> adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(QRecyclerAdapter<?> adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(QRecyclerAdapter<?> adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(QRecyclerAdapter adapter, View view, int position);
    }
