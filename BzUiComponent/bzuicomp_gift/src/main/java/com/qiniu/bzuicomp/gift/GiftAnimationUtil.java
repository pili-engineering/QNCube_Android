...
//        animSet.playSequentially(animators);
    ...
    public static AnimatorSet startAnimation( ObjectAnimator animator3, ObjectAnimator animator4, ObjectAnimator animator5) {
        AnimatorSet animSet = new AnimatorSet();
//        animSet.playSequentially(animators);
        animSet.play(animator3).before(animator4);
        animSet.play(animator5).after(animator4);
        animSet.start();
        return animSet;
    }
