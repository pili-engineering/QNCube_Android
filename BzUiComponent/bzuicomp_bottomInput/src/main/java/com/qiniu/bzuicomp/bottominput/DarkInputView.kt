...
import com.qiniu.bzuicomp.bottominput.databinding.MvRoomInputBinding

class DarkInputView : FrameLayout, IInputView {

    private lateinit var binding: MvRoomInputBinding
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        binding = MvRoomInputBinding.inflate(LayoutInflater.from(context), this, true)
        init()
    }
