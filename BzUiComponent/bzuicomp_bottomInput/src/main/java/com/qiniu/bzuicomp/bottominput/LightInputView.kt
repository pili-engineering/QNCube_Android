...
import com.qiniu.bzuicomp.bottominput.databinding.MvRoomInputLightBinding

class LightInputView : FrameLayout, IInputView {

    private lateinit var binding: MvRoomInputLightBinding
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        binding = MvRoomInputLightBinding.inflate(LayoutInflater.from(context), this, true)
        init()
    }
    ...
    private fun init() {
        ...
        binding.emojiBoard.setItemClickListener { code ->
            if (code == "/DEL") {
                ...
                binding.chatMessageInput.getText()
                    ?.insert(binding.chatMessageInput.selectionStart, code)
            }
        }
    }
