...
import com.qiniu.bzuicomp.bottominput.OrientationDetector
import com.qiniu.bzuicomp.bottominput.SoftKeyBoardListener
import kotlinx.android.synthetic.main.mv_room_input_light.view.*

class LightChatView : PubChatLeftRightView {
    ...
    override fun getIInputView(): IInputView {
        return MvInput(context)
    }

//    class MvChatAdapter   : BaseMultiItemQuickAdapter<PubChatLeftRightView.ChatMode, BaseViewHolder>(ArrayList<PubChatLeftRightView.ChatMode>()) {
//        init {
//            addItemType(ChatMode.left, R.layout.item_pubdialog_left);
//            addItemType(ChatMode.right, R.layout.item_pubdialog_right);
//            addItemType(ChatMode.center, R.layout.item_pubdialog_welcome);
//        }
//
//        override fun convert(helper: BaseViewHolder, item: PubChatLeftRightView.ChatMode) {
//
//        }
//    }
//

    class MvInput : FrameLayout, IInputView {
        ...
        constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
            ...
            val view = LayoutInflater.from(context)
                .inflate(R.layout.mv_room_input_light, this, false)
            addView(view)
            init()
        }
